/* exported findCentroid, findCornerForWindow */
function sqaure_distance(p1, p2) {
	return (p1.x - p2.x) * (p1.x - p2.x) +
        (p1.y - p2.y) * (p1.y - p2.y);
}
function transform_point(matrix, p) {
	return {
 ...
 */
function findCornerForWindow(win, centroid, corners) {
	var _a;
	...
	return (_a = mapped_corners[minIndex]) === null || _a === void 0 ? void 0 : _a.corner;
}
