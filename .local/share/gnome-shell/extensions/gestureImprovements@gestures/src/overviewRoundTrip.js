...
var OverviewRoundTripGestureExtension = class OverviewRoundTripGestureExtension {
	...
	apply() {
		...
		this._swipeTracker = createSwipeTracker(global.stage, (ExtSettings.DEFAULT_OVERVIEW_GESTURE ? [3] : [4]), Shell.ActionMode.NORMAL | Shell.ActionMode.OVERVIEW, Clutter.Orientation.VERTICAL);
